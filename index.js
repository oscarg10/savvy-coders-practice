...
// const checkTaskCompletion = todos.map(task => task.completed === true);

// console.log(checkTaskCompletion);
/**
 * keeps returning all of the completed tasks.
 * I understand that map creates a new array with the same lenght of the original
 *
 */

// console.log(checkTrueCompletions);

//check id's divisible by 10.
const checkOddId = todos.filter(todo => todo.id % 10 === 0);
//console.log(checkOddId);

//filter all the tasks that are completed
function checkTaskCompletion(tasks) {
  return tasks.completed;
}
// console.log(checkTaskCompletion(todos));
//* Isn't this supposed to return only the ones with "true" as their completion value?
//* In this case, use filter.

//Filter all the tasks that are not completed, and the map them so workhorse is assigned to userID = 1
...
// console.log(delegateIncompleteTasksToUser(todos, 1)); // Your code here!
/**
...
// console.log(getAllTasksForUser(todos, 1));
...
// console.log(tallyUserFive(todos));
