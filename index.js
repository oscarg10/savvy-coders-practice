...
// function to create a list of emails from comments data
function createFieldList(data, field) {
  // set up empty list to populate with email
  // map over data and only take the email and push it to the email list
  return data.map(d => d[field]);
}

// * this next section is optional and uses Set to grab only the unique values from the array
// * turns out they are all unique, so this isn't really necessary in this case
// const emailSet = new Set(emailList);
// return emailSet;

// return list of emails
console.log(createFieldList(comments, "name"));
